...
//    }
//
//    public func request<T: CustomDecodable, R: Request>(_ type: T.Type, with parameters: Parameters) -> R where R.Error == Error, R.Response == T.Object {
...
//    }
//
//    override func request<T: CustomDecodable, R: Request>(_ type: T.Type, with parameters: Parameters) -> R where R.Error == Error, R.Response == T.Object {
